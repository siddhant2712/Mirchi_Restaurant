      ...
      <div className={styles.content}>
        ...
        >
          <div className={styles.orderButtons}>
            <a href="https://www.swiggy.com/city/ballia/mirchi-restaurant-piparpati-piparpati-rest1171525?utm_source=GooglePlaceOrder&utm_campaign=GoogleMap&is_retargeting=true&media_source=GooglePlaceOrder" target="_blank" rel="noopener noreferrer" className={styles.swiggyBtn}>
              <ShoppingBag size={20} />
